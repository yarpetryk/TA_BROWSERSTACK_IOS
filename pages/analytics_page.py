...
class AnalyticsPage(BasePage):
    ...
    def check_consumption_sum(self, value):
        return self.check_element_equal(AnalyticsPageLocators.SECOND_TILE, value)

    @allure.step("And user check feedIn sum")
    def check_feedIn_sum(self, value):
        return self.check_element_equal(AnalyticsPageLocators.THIRD_TILE, value)
    ...
    def check_total_consumption_sum(self, value):
        return self.check_element_equal(AnalyticsPageLocators.FIRST_TILE, value)

    @allure.step("And user select Generatr from device picker")
