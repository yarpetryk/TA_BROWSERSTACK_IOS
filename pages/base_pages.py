...
class BasePage(object):
    ...
    ###################################################################################################
    @allure.step
    def find_element_and_click(self, locator, timeout=25, return_bool=False):
        """
        Purpose:
    ...
    @allure.step
    def find_element(self, locator, timeout=20) -> bool:
        """
        Purpose:
    ...
    @allure.step
    def wait_until_element_will_be_invisible(self, locator, timeout=20) -> bool:
        """
          Purpose:
    ...
    @allure.step
    def check_element_equal(self, locator, target : str, timeout=20) -> bool:
        """
        Purpose:
