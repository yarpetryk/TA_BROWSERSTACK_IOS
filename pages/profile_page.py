...
class ProfilePage(BasePage):
    ...
    @allure.step("And user click log out button")
    def click_log_out_button(self):
        self.find_element_and_click(ProfilePageLocators.LOG_OUT_ITEM)
    ...
    @allure.step("And user click on log out item")
    def click_log_out_item(self):
        self.find_element_and_click(ProfilePageLocators.LOG_OUT_ITEM)
